...
16. **บันทึกทุกขั้นตอนลง Audit Trail** — ทุกขั้นตอนของการอนุมัติและคอนเฟิร์มถูกบันทึกผู้กระทำ วันเวลา และรายละเอียดลง audit log ที่แก้ไขไม่ได้ (อ้างอิง FR-1.6, BL-008)

17. **คำขอเบิกฉุกเฉินนอกรอบ (แจ้งเตือนทันที)** — สำหรับคำขอเบิกฉุกเฉิน เภสัชกรได้รับ notify ทันทีเพื่อให้กระบวนการอนุมัติทั้งสองระดับเร็วขึ้นกว่าคำขอปกติ (อ้างอิง FR-1.7, US-1.4, BL-009)
